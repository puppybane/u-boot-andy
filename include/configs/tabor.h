...
#define CONFIG_ENV_OFFSET		(512 * 0x3000)
#elif defined(CONFIG_NAND)
#ifdef CONFIG_TPL_BUILD
#define CONFIG_ENV_SIZE		0x2000
...
#define CONFIG_SYS_PROMPT	"A1222> "	/* system command prompt */
